...
# Due to the DraperGems return type [Decorator],
# permissions are set on Decorators where applied,
# and not onto the decorated objects themselves.
# In the case that Draper is removed,
# this behavior is backed up by adding permissions
# onto the objects proper.
class Ability
